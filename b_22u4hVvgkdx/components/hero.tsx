      ...
      <div className="w-full max-w-5xl">
        ...
        <h1 className="mb-6 max-w-4xl text-4xl leading-tight tracking-tight md:text-5xl lg:text-6xl">
          <span className="whitespace-nowrap">
            ...
            <span className="font-sans font-bold">product designer</span>{" "}
            <span className="font-serif italic">building</span>
          </span>
          <br />
          <span className="font-serif italic">for</span>{" "}
          <span className="font-sans font-bold">social good.</span>
        </h1>

        {/* Description */}
        <p className="mb-2 max-w-3xl text-lg leading-relaxed text-muted-foreground md:text-xl">
          Designing research-driven, human-centered experiences at the intersection of technology +
          public life, community, and regenerative systems change.
        </p>
